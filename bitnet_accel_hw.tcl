...
add_interface_port avs_slave io_slave_address address Input 16
...
#
# connection point avm_master — Avalon-MM Master (DDR3 read/write, 128-bit matching f2sdram bridge)
#
...
add_interface_port avm_master io_master_write write Output 1
add_interface_port avm_master io_master_readdata readdata Input 128
add_interface_port avm_master io_master_writedata writedata Output 128
